...
const RANK_STYLES: Record<number, { bg: string; border: string; numColor: string }> = {
  1: { bg: "rgba(234,179,8,0.15)",   border: "rgba(234,179,8,0.4)",    numColor: "#7DD3FC" },
      ...
      <div className="container-app space-y-5">
        ...
        >
                ...
                return (
                  ...
                  >
                    {s.photo_url ? (
                      ...
                      <div
                        className="flex h-9 w-9 items-center justify-center rounded-full text-[11px] font-bold flex-shrink-0"
                        style={{ background: active ? "#168AE8" : colors.bg, color: "#fff" }}
                      >
                        {getInitials(s.name)}
                      </div>
                    )}
          ...
          {!anythingActive ? (
            ...
            <div
              className="max-h-[300px] overflow-y-auto rounded-2xl space-y-2 pr-1"
