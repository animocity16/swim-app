        ...
        {followingSwimmers.length > 0 && (
          <div className="space-y-3">
            ...
            {followingOpen && (
              <>
                <div className="space-y-3">
                  {/* Clear filter selector: All / Club / School */}
                  <div
                  ...
                  >
                    <button
                      ...
                      style={filterMode === "all"
                        ? { background: "rgba(217,119,6,0.24)", border: "1px solid rgba(253,230,138,0.35)", color: "#FDE68A" }
                  ...
                  {filterMode === "club" && clubs.length > 0 && (
                  ...
                  {filterMode === "school" && schools.length > 0 && (
                    <div className="space-y-2">
                      <p className="px-1 text-[10px] font-medium uppercase tracking-widest text-white/30">
                        Select school
                      </p>
